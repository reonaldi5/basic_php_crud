...
<table border="1" cellpadding="10" cellspacing="0" >
    ...
    <tr>
        ...
        <td>
            ...
            <!-- kita ingin hapus, data mana yang dihapus, gunakan field id sebagai primary key, menghapus data dengan id tertentu -->
            <!-- lalu liat hover delete di tabel, akan ada tampilan link dikiri bawah -->
